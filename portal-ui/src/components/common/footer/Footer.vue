	...
	<div class="footer">
		...
		<div class="footer--inner">
			<div class="am-g">
              ...
              <li class="footer_navigation--item"><router-link to="/product" class="footer_navigation--link">灯箱</router-link></li>
						</ul>
					</div>
				</div>
				<div class="am-u-md-6 ">
                ...
                诚信创造价值，品质源于专业”是公司的核心价值观。团结、创新、务实、奋进是公司矢志不渝的追求。公司倍加珍惜每一份荣誉，坚持“质量第一、用户至上、以质兴业、以优取胜”的经营宗旨。致力与我们的合作伙伴真诚相待，在“合作共赢”的理念下不断将优秀装饰产品贡献社会，与社会各界优势互补、同创辉煌！
							</p>
						</div>
					</div>
				</div>
