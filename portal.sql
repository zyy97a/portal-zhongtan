...
-- ----------------------------
INSERT INTO `t_company` VALUES (1, '佛山市钟潭装饰工程有限公司', '      佛山市钟潭装饰工程有限公司是一家专业装饰施工工程队，历经十余年的发展历程。公司主要承揽室内外装修工程、广告制作安装工程、钢结构安装工程、不锈钢工程。是一家具有丰富现场施工经验、专业技术团队的资深装饰企业。公司依靠技术团队、强化管理，坚持走品质新业之路。历年来完成南京青奥会室外大型配套广告安装工程、南方电网电力工程、龙建路桥钢结构安装工程等大型施工工程。并多次荣获《重质量、守信誉、诚信施工单位》 、 《安全生产文明施工管理先进单位》等称号。诚信创造价值，品质源于专业”是公司的核心价值观。团结、创新、务实、奋进是公司矢志不渝的追求。公司倍加珍惜每一份荣誉，坚持“质量第一、用户至上、以质兴业、以优取胜”的经营宗旨。致力与我们的合作伙伴真诚相待，在“合作共赢”的理念下不断将优秀装饰产品贡献社会，与社会各界优势互补、同创辉煌！', '15284739237', '广东省 佛山市', NULL, NULL, 0);
-- ----------------------------
